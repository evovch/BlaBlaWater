...
Основная задача магнита --- разводить в пространстве заряженные частицы для обеспечения возможности их регистрации детекторами, стоящими ниже по пучку.

Конфигурация магнита определяется геометрическим аксептансом эксперимента, который составляет полный 2$\pi$ по азимуту $\phi$) и интервал от 2.5$^{\circ}$ до 25$^{\circ}$ по полярному углу ($\theta$). Мишень, вершинный микродетектор MVD и кремниевая трековая система STS должны распологаться внутри магнитного поля, что диктует требование к размерам 
