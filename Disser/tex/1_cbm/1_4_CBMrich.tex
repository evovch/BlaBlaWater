...
\begin{table}[H]
\caption{Отношение сигнал-шум (S/B), вклад физических источников в процентах от общего числа пар в фоне и вклад ложно идентифицированных $\pi^{\pm}$ в процентах от электронов \todo после применения всех катов \todo подавления фона. Для доступа к лёгким векторным мезонам необходимо чтобы физические источники сигнала доминировали над фоном, что требует фактор одавления пионов более 5000. Таблица взята из~\cite{TDR_RICH}.}
\label{tabl:RICHchar}
