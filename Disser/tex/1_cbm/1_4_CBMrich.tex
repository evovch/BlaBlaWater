...
На~\figref{fig:RICHeff}, \figref{fig:InvMassSpectra} и табл.~\ref{tabl:RICHchar} показаны характеристики детектора CBM RICH, которые были получены в результате моделирования в среде CbmRoot с применением генератора UrQMD~\cite{URQMD}. С применением результатов анализа данных пучковых тестов прототипа. \todo
...
Эффективность реконструкции колец определяется как отношение $Efficiency = N_{reconstructed} / N_{accepted}$, где $N_reconstructed$ --- количестве верно найденных колец после реконструкции, а $N_{accepted}$ --- количество колец, находящихся в аксептансе RICH, которые возможно реконструировать, т.е. колец, имеющих минимум 7~зарегистрированных хитов в RICH.
