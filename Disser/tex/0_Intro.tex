...
В 2014 г. была закончена первая фаза программы скана по энергиям (Beam energy scan, BES) на RHIC с пучками $Au+Au$ энергий от 7 до 39 ГэВ/нуклон \todo
Набранные ранее данные расширяют диапазон энергий $sqrt(s_{NN})$ вверх до 200 ГэВ.
Вторая фаза BES запланирована на 2018--2019~гг. и будет сфокусирована на пучках $Au+Au$ при энергиях $sqrt(s_{NN})$ от 20 до 7 ГэВ/нуклон в режиме встречных пучков (коллайдера\todo) и $sqrt(s_{NN})$ от 7 до 3.5 ГэВ/нуклон в режиме с мишенью.
...
\hline
Энергия (ГэВ/нуклон) & Кол-во событий (млн.) & Время (недели) \\
\hline
200 & 350 & 11 \\
\hline
62.4 & 67 & 1.5 \\
