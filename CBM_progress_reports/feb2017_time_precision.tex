...
% starting from the MA~PMT entrance window and ending with timestamp generation. Time precision of one channel is dictated by the spread of the arriving photons in time
